...
#include <sys/types.h>
    ...
    // 2026/01/17 -rs: add 'Ws2_32.lib' to linker list
    // (see: https://stackoverflow.com/questions/16948064/unresolved-external-symbol-lnk2019)
...
int                 iRes;
    ...
    #if !defined(WIN32)      // -rs 2026/01/17: mask out for Windows
    {
